...
L["Warrior"] = true
L["Death Knight"] = true
L["Provides options to color player names, add player levels, and add tab completion of player names."] = "Provides options to decorate player names, and adds tab completion of names."
L["Save Data"] = true
