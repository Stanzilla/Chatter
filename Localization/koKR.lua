...
L["Enables you to right-click a person's name in chat and set a note on them to be displayed in chat, such as their main character's name."] = "플레이어 이름을 우 클릭해서 (메인 캐릭 이름 같은) 메모를 기록할 수 있습니다."
L["Set Main"] = "플레이어 메모"
...
L["Enables you to replace channel names with your own names"] = "채널 이름을 사용자가 변경할 수 있게 합니다."
