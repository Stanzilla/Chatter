...
L["Left Bracket"] = "왼쪽 브라캣"
L["Character to use for the left bracket"] = "캐릭터의 왼쪽 브라캣을 사용합니다."
L["Right Bracket"] = "오른쪽 브라캣"
L["Character to use for the right bracket"] = "캐릭터의 오른쪽 브라캣을 사용합니다."
