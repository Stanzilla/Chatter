...
L["Invite Links"] = "邀请链接"
L["Alt-click name to invite"] = "Alt点击邀请"
L["Lets you alt-click player names to invite them to your party."] = "允许你在按住Alt键的同时点击玩家的名字邀请他们加入你的小队"
L["Add Word"] = "添加关键词"
...
L["Reroute whole message to SCT"] = "将整条信息转发到SCT"
L["Reroute whole message to SCT instead of just displaying 'who said keyword in channel'"] = "将整条信息都转发到SCT而不是只显示“谁在频道里说了关键字”"
L["Sound File"] = "声音文件"
...
L["Color self in messages"] = "为自己名字着色"
L["Color own charname in messages."] = "在聊天信息中为自己的角色名字着色"
L["Emphasize self in messages"] = "括起自己的名字"
L["Add surrounding brackets to own charname in messages."] = "在聊天信息中为自己的角色名字添加左右括号"
L["Left Bracket"] = "左括号"
